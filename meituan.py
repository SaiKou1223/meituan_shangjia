...
msg_list = []
for i in range(30):
    url = 'https://apimobile.meituan.com/group/v4/poi/pcsearch/1?uuid=4bd920e3f9a346718440.1598617935.1.0.0&userid=-1&limit=32&offset={}&cateId=-1&q=%E8%B6%85%E5%B8%82'.format(i*32)
    print(url)
